...
func (s *Server) ToolsList() any {
	...
	tools := []map[string]any{
		...
		emptyTool("claim_list", "List canonical claims with derived state and revisions."),
...
func (s *Server) Capabilities() any {
	...
	payload := map[string]any{
		...
		"json_schemas": map[string]string{
			...
			"claim_list": publicapi.ClaimListSchema, "claim_validation_run": publicapi.ClaimValidationRunSchema,
